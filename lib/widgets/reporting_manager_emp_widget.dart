...
class ReportingManagerEmpWidget extends StatelessWidget {
  final report;
  final int length;
  final int index;
  final RepoManagerAttController rmaC;

  ReportingManagerEmpWidget(
    this.report,
    this.index,
    this.length,
    this.rmaC,
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          convertDateTime(report['shiftStartTime']),
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 14.0,
                            color: AppUtils().blueColor,
                        ...
                        Text(
                           convertDateTime(report['shiftEndTime']),
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 14.0,
                            color: AppUtils().blueColor,
