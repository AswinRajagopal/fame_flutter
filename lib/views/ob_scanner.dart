...
class _OBScannerState extends State<OBScanner> {
  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) async {
      ...
      if (scanData.code != null && scanData.code.isNotEmpty && scanData.code.isNumericOnly) {
        print('call API');
        var getAadharData = await RemoteServices().getAadharData(scanData.code);

        print('getAadharData: $getAadharData');
        // Get.back();
        ...
        adminC.name.text = getAadharData['name'];
        adminC.disabledName(true);

        adminC.permanenthouseNo.text = getAadharData['house'];
        adminC.presenthouseNo.text = getAadharData['house'];

        var dob = getAadharData['dob'];
        print('dob: $dob');
        adminC.dtOfBirth.text = getAadharData['dob'].toString();
        ...
        var gender = getAadharData['gender'];
        print('gender: $gender');
        ...
        adminC.permanentPincode.text = getAadharData['pincode'].toString();
        adminC.presentPincode.text = getAadharData['pincode'].toString();
      ...
      } else if (scanData.code != null && scanData.code.isNotEmpty) {
        adminC.proofAadharNumber.clear();
        adminC.proofAadharNumberConfirm.clear();
        adminC.name.clear();
        adminC.permanenthouseNo.clear();
